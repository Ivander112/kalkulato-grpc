...
type CalcServiceClient interface {
	CalcStart(ctx context.Context, in *CalcRequest, opts ...grpc.CallOption) (*CalcResponse, error)
}
...
func (c *calcServiceClient) CalcStart(ctx context.Context, in *CalcRequest, opts ...grpc.CallOption) (*CalcResponse, error) {
	out := new(CalcResponse)
	err := c.cc.Invoke(ctx, "/calculator.CalcService/CalcStart", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalcServiceServer interface {
	CalcStart(context.Context, *CalcRequest) (*CalcResponse, error)
...
func (UnimplementedCalcServiceServer) CalcStart(context.Context, *CalcRequest) (*CalcResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CalcStart not implemented")
}
...
func _CalcService_CalcStart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CalcRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalcServiceServer).CalcStart(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.CalcService/CalcStart",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalcServiceServer).CalcStart(ctx, req.(*CalcRequest))
	}
...
var CalcService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CalcStart",
			Handler:    _CalcService_CalcStart_Handler,
		},
	},
